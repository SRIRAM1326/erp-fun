  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Sales Partner Oversight</h1>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md animate-in fade-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between p-6 border-b border-slate-100">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">{editingRep ? 'Update rep details and status.' : 'Fill in details to register a new sales partner.'}</p>
              </div>
